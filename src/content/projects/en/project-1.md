...
## What Metronopy can do

I wanted to keep it focused—a tool that does one thing and does it flawlessly:

- Generate metronome sequences directly as video files.
- Full control over **tempo, time signature, and total duration**.
- Absolute accuracy thanks to its deterministic engine.
- Clean, **modular code** that is well-documented and easy to extend.

## Under the hood

This project served as my playground for applying **software architecture best practices**:

- I kept the domain logic separate from the infrastructure, chasing the **clean and sober code** I value so much.
